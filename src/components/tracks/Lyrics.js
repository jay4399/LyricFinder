    ...
    render() {
        ...
        if(track === undefined || lyrics === undefined || Object.keys(track).length === 0 || Object.keys(lyrics).length === 0 ){
            ...
            return (<React.Fragment>
                <Link to="/" className="btn btn-dark btn-lg mb-4">Back to Search</Link>
                <div className="card">
                ...
                <ul className="list-group mt-3">
                    ...
                    <li className="list-group-item">
                        <strong>Genre</strong>:{' '} { track.primary_genres.music_genre_list.length !== 0 ? track.primary_genres.music_genre_list[0].music_genre.music_genre_name: 'N/A'}</li>
                    <li className="list-group-item">
